...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { description: @deck.description, mark: @deck.mark, name: @deck.name, views: @deck.views }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { description: @deck.description, mark: @deck.mark, name: @deck.name, views: @deck.views }
    assert_redirected_to deck_path(assigns(:deck))
  end
