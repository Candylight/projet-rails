...
class ExtensionsControllerTest < ActionController::TestCase
  ...
  test "should create extension" do
    assert_difference('Extension.count') do
      post :create, extension: { name: @extension.name, release: @extension.release, standard: @extension.standard }
    end
  ...
  test "should update extension" do
    patch :update, id: @extension, extension: { name: @extension.name, release: @extension.release, standard: @extension.standard }
    assert_redirected_to extension_path(assigns(:extension))
  end
